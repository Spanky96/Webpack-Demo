...
List<GenericValue> list = NS.findEnts("ExtXKGridElementType", UtilMisc.toMap("isOpen", "1", "gridType", "1"), UtilMisc.toList("seqNum asc"), null);
%>
<!DOCTYPE html>
<html>
<head>
...
var zNodes = [
	...
	%>
	{id: '<%=ent.getString("typeId")%>', pId: '00', name: "<%=Global.getFieldLabel(ent, "typeName")%>", open: true, icon: '/scripts/ztree/zTreeStyle/img/diy/1_close.png'},
	<%
	}
	%>
];
